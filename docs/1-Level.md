...
- 정답:
1. 회원가입/로그인: 사용자는 서비스에 가입하고 개인의 주문 이력을 관리할 수 있어야합니다.
2. 가게 검색: 주문하고자 하는 가게 이름을 검색하여 진입할 수 있어야합니다.
3. 가게 상세 조회: 가게에서 제공하는 메뉴를 조회하고 주문하고자하는 메뉴를 담을 수 있어야합니다.
4. 주문: 선택된 메뉴에 대해 주문을 생성할 수 있어야합니다.
...
서비스는 6개월 뒤에 런칭하는 것이 목표입니다.
필요한 백엔드 개발 일정을 산정해주세요.
